...
KAREOSS Team`;
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] flex flex-col relative overflow-x-hidden text-amber-50">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 flex-1 w-full">
      ...
      {/* GLOBAL FOOTER */}
      <footer className="relative z-10 border-t border-amber-500/20 bg-black/60 backdrop-blur-md py-8 mt-auto w-full text-white/70 text-xs shrink-0">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <img src={clubLogo} alt="KAREOSS Logo" className="w-10 h-10 rounded-full border border-amber-500/50 object-cover shadow-lg shadow-amber-500/20 shrink-0" />
